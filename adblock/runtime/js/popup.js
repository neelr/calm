...
dom.on('#gotoReport', 'click', ev => {
    ...
    const reportURL = new URL(runtime.getURL('/adblock/runtime/report.html'));
...
dom.on('#gotoZapper', 'click', ( ) => {
    ...
    browser.scripting.executeScript({
        files: [ '/adblock/runtime/js/scripting/tool-overlay.js', '/adblock/runtime/js/scripting/zapper.js' ],
...
dom.on('#gotoPicker', 'click', ( ) => {
    ...
    browser.scripting.executeScript({
        files: [
            '/adblock/runtime/js/scripting/css-procedural-api.js',
            '/adblock/runtime/js/scripting/tool-overlay.js',
            '/adblock/runtime/js/scripting/picker.js',
        ],
        target: { tabId: currentTab.id },
    });
    self.close();
...
dom.on('#gotoUnpicker', 'click', ( ) => {
    ...
    browser.scripting.executeScript({
        files: [
            '/adblock/runtime/js/scripting/tool-overlay.js',
            '/adblock/runtime/js/scripting/unpicker.js',
        ],
        target: { tabId: currentTab.id },
    });
    self.close();
