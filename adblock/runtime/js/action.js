...
function disableToolbarIcon(tabId) {
    const details = {
        path: {
             '16': '/adblock/runtime/img/icon_16_off.png',
             '32': '/adblock/runtime/img/icon_32_off.png',
             '64': '/adblock/runtime/img/icon_64_off.png',
            '128': '/adblock/runtime/img/icon_128_off.png',
        }
    };
    if ( tabId !== undefined ) {
        details.tabId = tabId;
...
function enableToolbarIcon(tabId) {
    const details = {
        path: {
             '16': '/adblock/runtime/img/icon_16.png',
             '32': '/adblock/runtime/img/icon_32.png',
             '64': '/adblock/runtime/img/icon_64.png',
            '128': '/adblock/runtime/img/icon_128.png',
        }
    };
    if ( tabId !== undefined ) {
        details.tabId = tabId;
...
export async function registerToolbarIconToggler(context) {
    ...
    const directive = {
        id: 'toolbar-icon',
        js: [ '/adblock/runtime/js/scripting/toolbar-icon.js' ],
