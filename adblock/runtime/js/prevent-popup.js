...
export async function registerPreventPopup(context) {
    ...
    for ( const { id, popups } of context.rulesetsDetails ) {
        ...
        js.push(`/adblock/runtime/rulesets/scripting/popup/${id}.js`);
    }
    if ( js.length === 0 ) { return; }
    js.push(
        '/adblock/runtime/js/scripting/prevent-popup-target.js',
        '/adblock/runtime/js/scripting/prevent-popup.js'
    );
