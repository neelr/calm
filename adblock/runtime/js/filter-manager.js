...
export function startCustomFilters(tabId, frameId) {
    return browser.scripting.executeScript({
        files: [ '/adblock/runtime/js/scripting/css-user.js' ],
...
export function terminateCustomFilters(tabId, frameId) {
    return browser.scripting.executeScript({
        files: [ '/adblock/runtime/js/scripting/css-user-terminate.js' ],
        target: { tabId, frameIds: [ frameId ] },
        injectImmediately: true,
    }).catch(reason => {
...
export async function registerCustomFilters(context) {
    ...
    const directive = {
        id: 'css-user',
        js: [ '/adblock/runtime/js/scripting/css-user.js' ],
...
registerCustomScriptlets.create = async function() {
    ...
    const [ worlds ] = await Promise.all([
        ...
        browser.offscreen.createDocument({
            url: '/adblock/runtime/js/offscreen/compile-scriptlets.html',
            reasons: [ 'WORKERS' ],
